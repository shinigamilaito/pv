...
ActiveRecord::Schema.define(version: 20181212193327) do
  ...
  create_table "equipment_customers", force: :cascade do |t|
    ...
    t.index ["client_id"], name: "index_equipment_customers_on_client_id"
  ...
  create_table "sale_supports", force: :cascade do |t|
    t.bigint "equipment_customer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["equipment_customer_id"], name: "index_sale_supports_on_equipment_customer_id"
  end
  ...
  add_foreign_key "sale_supports", "equipment_customers"
end
