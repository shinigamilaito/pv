class CreateCashClosingServicesSales < ActiveRecord::Migration[5.1]
  def change
    create_table :cash_closing_services_sales do |t|
      ...
      t.references :cash_opening_services_sale,  index: { name: "cash_opening_services_sale" }, foreign_key: true
